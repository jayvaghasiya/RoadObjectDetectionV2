...
dataset_params = {
    ...
    'classes': ['person','car','rider','bus','truck','bike','motor','traffic light','traffic sign','train']
}
...
trainer = Trainer(experiment_name='bdd-model', ckpt_root_dir=CHECKPOINT_DIR)
